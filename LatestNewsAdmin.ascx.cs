...
namespace CMI_News
{
    public partial class LatestNewsAdmin : PortalModuleBase, IActionable
    {
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            try
            {
                colNews = objNews.GetCMI_NewssLatest();
                if (objNews.IsPublished())
                    lkbPublish.Text = "Undo Publish";
                else
                    lkbPublish.Text = "Publish Today's News";
            }
        ...
        protected void lkbPublish_Click(object sender, EventArgs e)
        {
            objNews.DoPublished();
            if (objNews.IsPublished())
                lkbPublish.Text = "Undo Publish";
