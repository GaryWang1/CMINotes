...
namespace CMI_News
{
    ...
    /// </history> 
    /// ----------------------------------------------------------------------------- 
    public partial class D2Industry : PortalModuleBase, IActionable
    {
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            colIndustry = objController.GetCMI_Industries2DigitByGroup(majorIndustryGroupId);
        ...
        protected void rgrList_OnUpdateCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
        {
            try
            {
                ...
                if (e.CommandName.Equals("Update"))
                {
                    ...
                    int SiCCode = Convert.ToInt32(dataItem.GetDataKeyValue("SIC2Digit").ToString());
                    string Industry = ((TextBox)dataItem["Industry2Digit"].Controls[0]).Text;

                    objController.UpdateCMI_2DigitIndustry(SiCCode, majorIndustryGroupId, Industry);
        ...
        protected void rgrList_OnInsertCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
        {
            try
            {
                if (e.CommandName.Equals("PerformInsert"))
                {
                    ...
                    GridEditableItem dataItem = (GridEditableItem)e.Item;
                    int SiCCode = Convert.ToInt32(((TextBox)dataItem["SiC2Digit"].Controls[0]).Text);
                    string Industry = ((TextBox)dataItem["Industry2Digit"].Controls[0]).Text;

                    objController.AddCMI_2DigitIndustry(SiCCode, majorIndustryGroupId, Industry);
        ...
        protected void rgrList_OnDeleteCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
        {
            if (e.CommandName.Equals("Delete"))
            {
                ...
                objController.DeleteCMI2DigitIndustry(SiCCode);
